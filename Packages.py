...
class stereopipeline(GITPackage):
    ...
    def configure(self):
        ...
        enable_apps  = 'bundlevis disparitydebug hsvmerge isisadjust orbitviz orthoproject point2dem point2las point2mesh stereo mer2camera rpcmapproject dem_geoid geodiff'
