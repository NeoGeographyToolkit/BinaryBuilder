...
class stereopipeline(GITPackage):
    ...
    def configure(self):
        ...
        enable_apps  = 'bundlevis disparitydebug hsvmerge isisadjust orbitviz orthoproject point2dem point2las point2mesh stereo mer2camera rpc_mapproject rpc_gen dem_geoid geodiff'
